...
from .utils import MLP, MLP_v2


class ContraText_DETR(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        hs, init_reference, inter_references, enc_outputs_class, enc_outputs_coord_unact, encoder_feat, encoder_attn_maps, decoder_attn_maps = self.transformer(
        ...
        out = {'pred_logits': outputs_class[-1], 'pred_ctrl_points': outputs_coord[-1], 'query_embed': hs[-1]}
