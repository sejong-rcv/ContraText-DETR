...
def cosine_similarity_loss(rec_feat_flat, rec_text_pooled):
  cosine_similarity = F.cosine_similarity(rec_feat_flat, rec_text_pooled, dim=-1)
    
  similarity_loss = 1 - cosine_similarity.mean()
