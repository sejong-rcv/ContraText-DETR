...
_C.MODEL.TRANSFORMER.LOSS.CONTRASTIVE = CN()
_C.MODEL.TRANSFORMER.LOSS.CONTRASTIVE.TEMPERATURE = 0.5
_C.MODEL.TRANSFORMER.LOSS.CONTRASTIVE.IOU_THRESHOLD = 0.4
_C.MODEL.TRANSFORMER.LOSS.CONTRASTIVE.WEIGHT = 2.0

# FP Annotation settings
_C.MODEL.TRANSFORMER.FP = CN()
_C.MODEL.TRANSFORMER.FP.ANNOTATION_PATH = ""
_C.MODEL.TRANSFORMER.FP.ENABLED = False
